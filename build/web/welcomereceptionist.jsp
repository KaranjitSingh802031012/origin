...
.center {
 ...
 <h2 align="center"><font><strong><h1>Welcome Rita</h1></strong></font></h2>
...
<button class="button" onclick="window.location.href='../onlineproj/StudentRecrecep.jsp'" type="button">Handle Student Record</button>
<BR>
