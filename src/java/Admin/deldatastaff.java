 ...
 * @author HP
 */
@WebServlet(name = "deldatastaff", urlPatterns = {"/deldatastaff"})
public class deldatastaff extends HttpServlet {
         ...
         int a=Integer.parseInt(delete);
             ...
             Class.forName("com.mysql.jdbc.Driver").newInstance();
               con=DriverManager.getConnection("jdbc:mysql://localhost:3306/staffinf","root","1234");
                 String str="Delete from staffinf  where staff_id='"+Math.abs(a)+"'";
